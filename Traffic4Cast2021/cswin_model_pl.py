...
from .transformer_models import Model as AllModel
# from .graph_models import GraphTransformer
...
class Model(pl.LightningModule):
    ...
    def add_model_specific_args(parent_parser):
        ...
        parser.add_argument('--model_name', default='small', help='transformer model name ',
                            choices=['tiny', 'small', 'base', 'large'])
        parser.add_argument('--backbone', default='cswin', help='type of backbone transformer model',
                            choices=['swin', 'cswin', 'star'])
        parser.add_argument('--head', default='upernet', help='type of decode head used',
                            choices=['upernet', 'unet', 'fapn'])
        # parser.add_argument('--patch_size', type=int, default=2, help='patch size to use in swin transformer')
        # parser.add_argument('--depth', type=int, default=4*2, help='depth of encoder blocks (default: 1)')
        # parser.add_argument('--decode_depth', type=int, default=2, help='depth of encoder blocks (default: None)')
        # parser.add_argument('--mlp_ratio', type=int, default=1, help='mlp ratio of transformer layer (default: 4)')
        # parser.add_argument('--start_filters', type=int, default=16 * 6,  # 16 * 8,
        #                     help='number of feature maps (default: 16*8)')
        # parser.add_argument('--stages', type=int, default=1,
        #                     help='number of encoder stages (default:1)')
        parser.add_argument('--dropout', type=float, default=0.0, help='dropout probability')
        parser.add_argument('--optimizer', default='adamw', help='optimizer to train with (default: swats)',
                            choices=['sgd', 'adam', 'adamw', 'swats', 'lamb'])
